...
return [total,product,message1,message2];
}
...
var total= sum(2,3)[0]
var total2=sum(total,4)[0];
var message3='2,3,4 was passed in as an array of numbers, and 9 is their sum.';
return [total2,message3];
}
...
var product = multiply(1,2)[0];
var product2 = multiply(product,3)[0];
var product3 = multiply(product2,4)[0];
var product4 = multiply(product3,5)[0];
var message= 'The numbers 1,2,3,4,5 have a product of 120.'   
return[product4,message]
}
